...
<head>
  ...
  <style>
  .diaryList{width:800px; }
  .diaryList th, .diaryList td, .diaryList {padding:10px;}
  .title2{font-size:15px; color:white;}
  .num{font-size:15px; color:white;}
  .inputdate{font-size:15px; color:white;}
  </style>
</head>
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h3 class="title">&nbsp&nbspDiary List</h3>
             </div>
             	<table class="diaryList" >
           	<tr>
           		<th class="num">번호</th>
           		<th class="title2">제목</th>
           		<th class="inputdate">작성 날짜</th>
           	</tr>
           	<c:forEach var="i" items="${diaryList}">
           	<tr>
           		<td class="num">${i.num}</td>
           		<td class="title2"><a href="read?num=${i.num}">${i.title}</a></td>
           		<td class="inputdate">${i.inputdate}</td>
           	</tr>
           	</c:forEach>
         </table>
