...
function total(lon1, lat1, lon2, lat2){
	...
	//경유지 넣는 곳. 보행자와 자전거의 경우 “_”를 통해서, 자동차 경로탐색의 경우 “,0,0,0_”로 구분 되며 마지막 경유지는 ",0,G,0"를 붙여 주어야 함.
	var passList = "126.82365493654832,37.456770374096615,0,0,0_126.82465493654832, 37.456770374106615,0,G,0";
